...
export type { Bounds, Matrix } from './paint/Paint';
export type { RectOptions, StrokeOptions } from './paint/Shape';
export type { LoadDataOptions, PictureSize } from './paint/Picture';
export type { TextLayout, TextOutline } from './paint/Text';
...
/** @category Picture */
export type { MimeType } from './constants';
