...
export interface ThorVGCAPI {
  ...
  _tvg_scene_reset_effects(scene: number): number;
  _tvg_scene_push_effect_gaussian_blur(scene: number, sigma: number, direction: number, border: number, quality: number): number;
  _tvg_scene_push_effect_drop_shadow(scene: number, r: number, g: number, b: number, a: number, angle: number, distance: number, sigma: number, quality: number): number;
  _tvg_scene_push_effect_fill(scene: number, r: number, g: number, b: number, a: number): number;
  _tvg_scene_push_effect_tint(scene: number, black_r: number, black_g: number, black_b: number, white_r: number, white_g: number, white_b: number, intensity: number): number;
  _tvg_scene_push_effect_tritone(scene: number, shadow_r: number, shadow_g: number, shadow_b: number, midtone_r: number, midtone_g: number, midtone_b: number, highlight_r: number, highlight_g: number, highlight_b: number, blend: number): number;
