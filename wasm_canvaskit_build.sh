...
# Builds ThorVG library + Canvas Kit bindings and copies output to dist/
#
...
meson setup -Db_lto=true --cross-file /tmp/.wasm_canvaskit_cross.txt build_wasm_canvaskit ../../bindings/canvas_kit
