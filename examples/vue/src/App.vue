...
onMounted(async () => {
  try {
    ...
    error.value = err instanceof Error ? err.message : 'Failed to initialize WebCanvas';
...
<template>
  <div class="app">
    <h1 class="app_title">ThorVG Vue Usage Example</h1>
    ...
    <section class="example-section">
      ...
      <p v-if="initialized" class="success">WebCanvas initialized successfully!</p>
      <canvas
        id="webcanvas"
        width="800"
        height="600"
