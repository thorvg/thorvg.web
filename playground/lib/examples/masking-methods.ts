...
(async () => {
...

  {
    ...
    mask.mask(add, TVG.MaskMethod.Add); // MaskMethod.Add
    shape.mask(mask, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(shape);
    ...
    mask2.mask(sub, TVG.MaskMethod.Subtract); // MaskMethod.Subtract
    shape2.mask(mask2, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(shape2);
    ...
    mask3.mask(inter, TVG.MaskMethod.Intersect); // MaskMethod.Intersect
    shape3.mask(mask3, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(shape3);
    ...
    mask4.mask(diff, TVG.MaskMethod.Difference); // MaskMethod.Difference
    shape4.mask(mask4, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(shape4);
    ...
    mask5.mask(light, TVG.MaskMethod.Lighten); // MaskMethod.Lighten
    shape5.mask(mask5, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(shape5);
    ...
    mask6.mask(dark, TVG.MaskMethod.Darken); // MaskMethod.Darken
    shape6.mask(mask6, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(shape6);
  }
  {
    //Shape + Shape Mask Add
    ...
    add.fill(255, 255, 255);
    mask.mask(add, TVG.MaskMethod.Add); // MaskMethod.Add
    shape.mask(mask, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(shape);
    ...
    sub.fill(255, 255, 255);
    mask2.mask(sub, TVG.MaskMethod.Subtract); // MaskMethod.Subtract
    shape2.mask(mask2, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(shape2);
    ...
    inter.fill(255, 255, 255);
    mask3.mask(inter, TVG.MaskMethod.Intersect); // MaskMethod.Intersect
    shape3.mask(mask3, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(shape3);
    ...
    diff.fill(255, 255, 255);
    mask4.mask(diff, TVG.MaskMethod.Difference); // MaskMethod.Difference
    shape4.mask(mask4, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(shape4);
    ...
    light.fill(255, 255, 255);
    mask5.mask(light, TVG.MaskMethod.Lighten); // MaskMethod.Lighten
    shape5.mask(mask5, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(shape5);
    ...
    dark.fill(255, 255, 255);
    mask6.mask(dark, TVG.MaskMethod.Darken); // MaskMethod.Darken
    shape6.mask(mask6, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(shape6);
  }
  {
    //Rect + Rect Mask Add
  ...
  }
  {
    ...
    image.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 }).size(80, 175.78);
    ...
    add.fill(255, 255, 255);
    mask.mask(add, TVG.MaskMethod.Add); // MaskMethod.Add
    image.mask(mask, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(image);

    //Transformed Image + Shape Mask Subtract
    const image2 = new TVG.Picture();
    image2.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 }).size(80, 175.78);
    ...
    sub.fill(255, 255, 255);
    mask2.mask(sub, TVG.MaskMethod.Subtract); // MaskMethod.Subtract
    image2.mask(mask2, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(image2);

    //Transformed Image + Shape Mask Intersect
    const image3 = new TVG.Picture();
    image3.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 }).size(80, 175.78);
    ...
    mask3.mask(inter, TVG.MaskMethod.Intersect); // MaskMethod.Intersect
    image3.mask(mask3, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(image3);

    //Transformed Image + Shape Mask Difference
    const image4 = new TVG.Picture();
    image4.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 }).size(80, 175.78);
    ...
    diff.fill(255, 255, 255);
    mask4.mask(diff, TVG.MaskMethod.Difference); // MaskMethod.Difference
    image4.mask(mask4, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(image4);

    //Transformed Image + Shape Mask Lighten
    const image5 = new TVG.Picture();
    image5.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 }).size(80, 175.78);
    ...
    light.fill(255, 255, 255);
    mask5.mask(light, TVG.MaskMethod.Lighten); // MaskMethod.Lighten
    image5.mask(mask5, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(image5);

    //Transformed Image + Shape Mask Darken
    const image6 = new TVG.Picture();
    image6.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 }).size(80, 175.78);
    ...
    dark.fill(255, 255, 255);
    mask6.mask(dark, TVG.MaskMethod.Darken); // MaskMethod.Darken
    image6.mask(mask6, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
    canvas.add(image6);
  }
  {
    //Transformed Image + Shape Mask Add
    const image = new TVG.Picture();
    image.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 });
    ...
    add.fill(255, 255, 255);
    mask.mask(add, TVG.MaskMethod.Add); // MaskMethod.Add
    image.mask(mask, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(image);

    //Transformed Image + Shape Mask Subtract
    const image2 = new TVG.Picture();
    image2.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 });
    ...
    sub.fill(255, 255, 255);
    mask2.mask(sub, TVG.MaskMethod.Subtract); // MaskMethod.Subtract
    image2.mask(mask2, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(image2);

    //Transformed Image + Shape Mask Intersect
    const image3 = new TVG.Picture();
    image3.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 });
    ...
    inter.fill(255, 255, 255, 127);
    mask3.mask(inter, TVG.MaskMethod.Intersect); // MaskMethod.Intersect
    image3.mask(mask3, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(image3);

    //Transformed Image + Shape Mask Difference
    const image4 = new TVG.Picture();
    image4.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 });
    ...
    diff.fill(255, 255, 255);
    mask4.mask(diff, TVG.MaskMethod.Difference); // MaskMethod.Difference
    image4.mask(mask4, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(image4);

    //Transformed Image + Shape Mask Lighten
    const image5 = new TVG.Picture();
    image5.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 });
    ...
    light.fill(255, 255, 255);
    mask5.mask(light, TVG.MaskMethod.Lighten); // MaskMethod.Lighten
    image5.mask(mask5, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(image5);

    //Transformed Image + Shape Mask Darken
    const image6 = new TVG.Picture();
    image6.loadData(imageData, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 });
    ...
    dark.fill(255, 255, 255);
    mask6.mask(dark, TVG.MaskMethod.Darken); // MaskMethod.Darken
    image6.mask(mask6, TVG.MaskMethod.InvAlpha); // MaskMethod.InvAlpha
    canvas.add(image6);
  }
