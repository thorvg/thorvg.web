...
//Solid Rectangle
{
  ...
  fill.addStop(0, [0, 0, 0, 255]);
  fill.addStop(1, [255, 255, 255, 255]);
  shape.fill(fill);
...
//Star
{
  ...
  fill1.addStop(1, [1, 255, 255, 255]);
  shape1.fill(fill1);

  shape1.mask(mask1, TVG.MaskMethod.Alpha); // MaskMethod.Alpha
  canvas.add(shape1);
}
...
// Star
{
  ...
  fill3.addStop(0, [0, 0, 0, 255]);
  fill3.addStop(1, [1, 255, 255, 255]);
  shape3.fill(fill3);
