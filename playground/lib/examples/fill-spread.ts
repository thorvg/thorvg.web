...
//Radial grad
{
  ...
  fill1.setStops(...colorStops.map(([offset, r, g, b, a]) => [offset, [r, g, b, a]]));
  ...
  fill2.setStops(...colorStops.map(([offset, r, g, b, a]) => [offset, [r, g, b, a]]));
  ...
  fill3.setStops(...colorStops.map(([offset, r, g, b, a]) => [offset, [r, g, b, a]]));
