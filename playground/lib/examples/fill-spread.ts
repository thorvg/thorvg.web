...
//Radial grad
{
  ...
  fill1.addStop(colorStops[0][0], colorStops[0][1]);
  fill1.addStop(colorStops[1][0], colorStops[1][1]);
  fill1.addStop(colorStops[2][0], colorStops[2][1]);
  fill1.addStop(colorStops[3][0], colorStops[3][1]);
  fill1.spread('pad');
  shape1.fill(fill1);
  ...
  fill2.addStop(colorStops[0][0], colorStops[0][1]);
  fill2.addStop(colorStops[1][0], colorStops[1][1]);
  fill2.addStop(colorStops[2][0], colorStops[2][1]);
  fill2.addStop(colorStops[3][0], colorStops[3][1]);
  fill2.spread('reflect');
  shape2.fill(fill2);
  ...
  fill3.addStop(colorStops[0][0], colorStops[0][1]);
  fill3.addStop(colorStops[1][0], colorStops[1][1]);
  fill3.addStop(colorStops[2][0], colorStops[2][1]);
  fill3.addStop(colorStops[3][0], colorStops[3][1]);
  fill3.spread('repeat');
  shape3.fill(fill3);
