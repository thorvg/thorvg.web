...
(async () => {
  ...
  text('An extreme-long-length-word to test with top-left.', {x: 18.75, y: 146.25}, {x: 0, y: 0}, TVG.TextWrapMode.Word);
  
  guide(word, 217.5, 146.25);
  text('An extreme-long-length-word to test with middle-center.', {x: 217.5, y: 146.25}, {x: 0.5, y: 0.5}, TVG.TextWrapMode.Word);
  
  guide(word, 412.5, 146.25);
  text('An extreme-long-length-word to test with bottom-right.', {x: 412.5, y: 146.25}, {x: 1, y: 1}, TVG.TextWrapMode.Word);
  
  const smart = 'TextWrap::Smart';
  guide(smart, 18.75, 273.75);
  text('An extreme-long-length-word to test with top-left.', {x: 18.75, y: 273.75}, {x: 0, y: 0}, TVG.TextWrapMode.Smart);
  
  guide(smart, 217.5, 273.75);
  text('An extreme-long-length-word to test with middle-center.', {x: 217.5, y: 273.75}, {x: 0.5, y: 0.5}, TVG.TextWrapMode.Smart);
  
  guide(smart, 412.5, 273.75);
  text('An extreme-long-length-word to test with bottom-right.', {x: 412.5, y: 273.75}, {x: 1, y: 1}, TVG.TextWrapMode.Smart);
