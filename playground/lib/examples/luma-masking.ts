...
(async () => {
  ...
  //Luma Masking
  {
    ...
    mask.mask(nMask, TVG.MaskMethod.Luma); // MaskMethod.Luma
    shape.mask(mask, TVG.MaskMethod.Luma); // MaskMethod.Luma
    canvas.add(shape);
    ...
    svg.mask(mask2, TVG.MaskMethod.Luma); // MaskMethod.Luma
    canvas.add(svg);
    ...
    star.mask(mask3, TVG.MaskMethod.Luma); // MaskMethod.Luma
    canvas.add(star);
    ...
    image.mask(mask4, TVG.MaskMethod.Luma); // MaskMethod.Luma
    canvas.add(image);
  }
  ...
  //Inverse Luma Masking
  {
    ...
    mask.mask(nMask, TVG.MaskMethod.InvLuma); // MaskMethod.InvLuma
    shape.mask(mask, TVG.MaskMethod.InvLuma); // MaskMethod.InvLuma
    canvas.add(shape);
    ...
    mask2.fill(255, 255, 255);
    svg.mask(mask2, TVG.MaskMethod.InvLuma); // MaskMethod.InvLuma
    canvas.add(svg);
    ...
    mask3.fill(0, 255, 255);
    star.mask(mask3, TVG.MaskMethod.InvLuma); // MaskMethod.InvLuma
    canvas.add(star);
    ...
    mask4.add(mask4_rect);
    mask4.add(mask4_circle);
    image.mask(mask4, TVG.MaskMethod.InvLuma); // MaskMethod.InvLuma
    canvas.add(image);
  }
