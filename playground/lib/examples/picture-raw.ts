...
(async () => {
  ...
  picture.loadData(data, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 });
  picture.translate(260, 162.5);
  canvas.add(picture);

  //Picture 2: Rotated, scaled, with opacity and clipping
  const picture2 = new TVG.Picture();
  picture2.loadData(data, { format: 'raw', width: 200, height: 300, colorSpace: TVG.ColorSpace.ARGB8888 });

  picture2.translate(260, 130);
  picture2.rotate(47);
  picture2.scale(0.975);
  picture2.opacity(0.502);
