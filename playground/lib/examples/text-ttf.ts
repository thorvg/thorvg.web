...
(async () => {
  ...
  text1.font('PublicSans-Regular')
    .fontSize(38)
    .text('THORVG TrueType Font')
    .fill(255, 255, 255);
  canvas.add(text1);
  ...
  text2.font('PublicSans-Regular')
    .fontSize(18)
    .italic()
    .text('Font = "PublicSans-Regular", Size = 18, Style = Italic')
    .fill(255, 255, 255)
    .translate(0, 88);
  canvas.add(text2);
