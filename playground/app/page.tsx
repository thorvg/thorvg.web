        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-[#737373] mt-1">Interactive examples for ThorVG Canvas Kit</p>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {showcaseExamples.map((example) => (
            ...
            >
              {/* Thumbnail / Preview */}
              <div className="aspect-video bg-[#e8e8e8] flex items-center justify-center relative overflow-hidden">
                {example.thumbnail ? (
                  <Image
              ...
              <div className="bg-[#2d2d30] p-6 min-h-[200px] flex flex-col">
        ...
        <div className="mt-12 p-6 bg-white border border-[#e0e0e0] rounded-lg">
          ...
          <pre className="bg-[#f6f6f6] border border-[#e0e0e0] p-4 rounded-md text-sm overflow-x-auto font-mono">
            <code className="text-[#047857]">npm install @thorvg/canvas-kit</code>
            <br />
            <code className="text-[#999999]"># or</code>
            <br />
            <code className="text-[#047857]">yarn add @thorvg/canvas-kit</code>
          </pre>
        </div>
      </main>
    </div>
